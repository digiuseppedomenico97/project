...
<div class="containeruno"><h1 class="display-4 text-center">Archivio Corso <i class="fa-solid fa-building-user"></i></h1></div>
...
<FORM method="post" action="/WebProjectMavenized/CtrlArchivioCorso" name="ArchivioCorso">
  ...
  <DIV align="center">
    ...
    <TR>
      <TD>
        <input type="radio" name="rdoIDCorso" value="<%=((Corso)pgsElenco.get(0)).getChiave() %>" > </TD>
      <TD> <%= ((Corso)pgsElenco.get(0)).getNome() %></TD>
      <TD> <%= ((Corso)pgsElenco.get(0)).getDurata() %></TD>
      <TD><%=((Corso)pgsElenco.get(0)).getoDocente().getCognome()%></TD>
    </TR>
    ...
    <TR>
      <TD>
        <input type="radio" name="rdoIDDiscente" value="<%= ((Corso)pgsElenco.get(i)).getChiave() %>" >
      </TD>
